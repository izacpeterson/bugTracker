<template>
  <div>
    ...
    <ul>
      <li v-for="project in projects" :key="project.uuid" class="card bg-base-100 mb-10 mx-10">
        <div class="items-center text-center">
          <nuxt-link :to="'/project/' + project.uuid" class="text-xl font-bold">{{ project.name }}</nuxt-link>
